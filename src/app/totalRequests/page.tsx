        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="flex-grow flex flex-row">
                <div className="flex flex-col gap-4 bg-white shadow-md w-12 items-center">
                    <div className={`mt-5 cursor-pointer ${view === 'allRequests' ? "text-yellow-500" : "text-gray-400"}`} onClick={()=> setView("allRequests")}>
                        <LuArrowLeftRight size={23} />
                    </div>
                    <div className={`mt-5 cursor-pointer ${view === 'allRequests' ? "text-gray-500" : "text-yellow-400"}`} onClick={()=> setView("myRequests")}>
                        <IoPerson size={23} />
                    </div>
                </div>
               
               <div>
                {view === "allRequests" ? allRequests() : myRequests()}
               </div>
            </div>
        </div>
    );
