  ...
  const myRequests = () => {
    return (
      <div className="p-4 flex flex-col w-full">
        ...
        <div className="grid grid-cols-7 py-2.5 px-2 text-center text-xs font-bold bg-gray-200 rounded-lg my-2">
          <div>Request ID</div>
          <div>From</div>
          <div>To</div>
          <div>When</div>
          ...
          <div>Status</div>
          <div>Edit</div>{" "}
          {/* Assuming there's an edit column based on your previous image */}
        </div>
            ...
            {requests
              ...
              .map((request, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-center bg-zinc-300 text-gray-800 py-1 rounded capitalize">
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-grow flex flex-row">
        ...
        <div>{view === "allRequests" ? allRequests() : myRequests()}</div>
      </div>
    </div>
  );
};
