            ...
            {companies.map((company, index) => (
              ...
              >
                <Card className="h-[260px] relative hover:border hover:border-[#4dabf7] hover:border-1 ">
                  <h5 className="h-[20%] text-xl font-semibold tracking-tight text-gray-900 dark:text-white hover:text-[#228be6] cursor-pointer" onClick={() => handleCompanyProfile(company.startup_id.toString())}>
